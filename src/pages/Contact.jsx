      ...
      <div className="max-w-[1360px] mx-auto px-6 md:px-12 py-16">
        ...
        <Reveal className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted text-lg leading-relaxed">
            Have questions about our medical coding platform, EHR integration, or custom software solutions? Send us a message and our team will get back to you within 24 hours.
          </p>
        </Reveal>
            ...
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-muted text-sm max-w-md mx-auto">
                  Your message has been received. One of our clinical software specialists will contact you shortly.
                </p>
                <button
                  onClick={() => setSubmitted(false)}
                  className="mt-4 px-6 py-2.5 rounded-xl bg-indigo/10 text-indigo font-bold text-sm hover:bg-indigo hover:text-white transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-xl font-bold text-white bg-brand-gradient shadow-btn-primary hover:opacity-95 transition-opacity text-sm"
                >
                  Send Message →
                </button>
              </form>
