...
export const Navbar = ({
  ...
  // ==========================================
  useEffect(() => {
    // Don't calculate Home/About/Services/etc.
    // on subpages or legal pages.
    if (isSubpage || isLegalPage) {
      setScrolled(true);
      return;
    }
    ...
    const updateActiveSection = () => {
      ...
      for (let i = sections.length - 1; i >= 0; i--) {
        ...
        if (
          element &&
          element.getBoundingClientRect().top <= 160
        ) {
  ...
  const isLinkActive = (link) => {
    ...
    return isSubpage
      ? subpageActiveSection === currentSection
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 flex items-center justify-between">
        ...
        {/* ================= DESKTOP NAV ================= */}
        <nav
          className="hidden lg:flex items-center gap-1 bg-slate-100/70 p-1.5 rounded-full border border-slate-200/50 shadow-inner"
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div
              className="w-5 flex flex-col items-center justify-center gap-1.5"
              aria-hidden="true"
            >
              <span
            ...
            return (
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {isActive && (
                    <span
                      className="w-2 h-2 rounded-full bg-[#6d45e5] animate-pulse"
                      aria-hidden="true"
                    />
                  )}
